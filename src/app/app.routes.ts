...
export const routes: Routes = [
  ...
  { path: 'gestao/novo/:fileName',  loadComponent: () => import('./pages/gestao/novo-evento-winzard.component/novo-evento-winzard.component').then(m => m.NovoEventoWinzardComponent) }
];
